...
public partial class Program
{
	...
	public enum MenuItemActive
	{
		Enabled,
		Disabled
	}

	public enum MenuItemVisible
	{
		Visible,
		Hidden
	}
	...
	private static readonly string versie = " - Johan Vandaele (VDAB) - Versie 20220501";
	...
	private static void ToonMenuHorizontal(SubMenu menuItem)
	{
		...
		keuze = LeesString($"Geef uw keuze ({menuItem.Input})", 1, OptionMode.Mandatory)!.ToUpper().ToCharArray()[0];
